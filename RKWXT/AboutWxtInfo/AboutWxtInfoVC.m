...
-(void)createBaseView{
    ...
    [textlabel setFont:WXTFont(18.0)];
...
//    [versionLabel setTextColor:WXColorWithInteger(0x000000)];
    ...
    [checkBtn setBorderRadian:10.0 width:0.5 color:[UIColor grayColor]];
    ...
    [checkBtn setTitleColor:[UIColor grayColor] forState:UIControlStateSelected];
