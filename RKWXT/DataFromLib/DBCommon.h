...
#define kWXTCallTable                       @"CREATE TABLE IF NOT EXISTS CallRecord (cid INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT,telephone TEXT, date TEXT, type INTEGER,area varchar(16),count INTEGER)"
