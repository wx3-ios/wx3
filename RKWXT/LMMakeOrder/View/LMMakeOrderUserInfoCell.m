...
@interface LMMakeOrderUserInfoCell(){
    UILabel *_nameLabel;
    UILabel *_phoneLabel;
    UILabel *_addLabel;
}
...
@implementation LMMakeOrderUserInfoCell
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if(self){
        ...
        bgView.frame = CGRectMake(0, yOffset, IPHONE_SCREEN_WIDTH, LMMakeOrderUserInfoCellHeight-2*yOffset);
        ...
        downImgView.frame = CGRectMake(0, LMMakeOrderUserInfoCellHeight-2*yOffset-2, IPHONE_SCREEN_WIDTH, 2);
