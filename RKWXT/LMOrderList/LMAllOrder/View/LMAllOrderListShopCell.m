...
@interface LMAllOrderListShopCell(){
    WXUILabel *nameLabel;
...
@implementation LMAllOrderListShopCell
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if(self){
        ...
        imgView.frame = CGRectMake(xOffset, (LMAllOrderListShopCellHeight-imgHeight)/2, imgWidth, imgHeight);
        ...
        nameLabel.frame = CGRectMake(xOffset, (LMAllOrderListShopCellHeight-nameLabelheight)/2, nameLabelWidth, nameLabelheight);
        ...
        arrowImgView.frame = CGRectMake(xOffset, (LMAllOrderListShopCellHeight-height)/2, width, height);
        ...
        stateLabel.frame = CGRectMake(IPHONE_SCREEN_WIDTH-10-stateLabelWidth, (LMAllOrderListShopCellHeight-statelabelHeight)/2, stateLabelWidth, statelabelHeight);
