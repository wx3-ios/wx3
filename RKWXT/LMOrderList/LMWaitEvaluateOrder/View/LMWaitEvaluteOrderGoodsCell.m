...
@interface LMWaitEvaluteOrderGoodsCell(){
...
@implementation LMWaitEvaluteOrderGoodsCell
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if(self){
        ...
        imgView = [[WXRemotionImgBtn alloc] initWithFrame:CGRectMake(xOffset, (LMWaitEvaluteOrderGoodsCellHeight-imgHeight)/2, imgWidth, imgHeight)];
