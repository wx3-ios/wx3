...
@implementation LMWaitPayOrderGoodsCell
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if(self){
        ...
        imgView = [[WXRemotionImgBtn alloc] initWithFrame:CGRectMake(xOffset, (LMWaitPayOrderGoodsCellHeight-imgHeight)/2, imgWidth, imgHeight)];
