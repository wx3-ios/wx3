...
@implementation SellerClassifyListCell
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if(self){
        ...
        imgView = [[WXRemotionImgBtn alloc] initWithFrame:CGRectMake(xOffset, (SellerClassifyListCellHeight-imgHeight)/2, imgWidth, imgHeight)];
