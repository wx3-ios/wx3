...
-(void)load{
    ...
    [_imgView setCpxViewInfo:entity.all_goodsImg];
    [_imgView load];
    [_nameLabel setText:entity.all_goodsName];
    [_priceLabel setText:[NSString stringWithFormat:@"￥%.2f",entity.all_shopPrice]];
}
