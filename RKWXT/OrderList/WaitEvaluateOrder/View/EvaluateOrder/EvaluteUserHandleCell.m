...
@interface EvaluteUserHandleCell(){
...
@implementation EvaluteUserHandleCell
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if(self){
        ...
        nameLabel.frame = CGRectMake(xOffset, (EvaluteUserHandleCellHeight-labelHeight)/2, labelWidth, labelHeight);
        ...
        fivethBtn.frame = CGRectMake(IPHONE_SCREEN_WIDTH-xGap, (EvaluteUserHandleCellHeight-btnHeight)/2, btnWidth, btnHeight);
        ...
        forthBtn.frame = CGRectMake(IPHONE_SCREEN_WIDTH-xGap, (EvaluteUserHandleCellHeight-btnHeight)/2, btnWidth, btnHeight);
        ...
        thirdBtn.frame = CGRectMake(IPHONE_SCREEN_WIDTH-xGap, (EvaluteUserHandleCellHeight-btnHeight)/2, btnWidth, btnHeight);
        ...
        secondBtn.frame = CGRectMake(IPHONE_SCREEN_WIDTH-xGap, (EvaluteUserHandleCellHeight-btnHeight)/2, btnWidth, btnHeight);
        ...
        firstBtn.frame = CGRectMake(IPHONE_SCREEN_WIDTH-xGap, (EvaluteUserHandleCellHeight-btnHeight)/2, btnWidth, btnHeight);
...
-(void)evaluteBtnClicked:(id)sender{
    ...
    if(_delegate && [_delegate respondsToSelector:@selector(userEvaluateGoods:goodsID:)]){
        [_delegate userEvaluateGoods:sign goodsID:entity.goods_id];
    }
}
