...
#import "WaitSendGoodsInfoCell.h"
#import "WXRemotionImgBtn.h"

@interface WaitSendGoodsInfoCell(){
    WXRemotionImgBtn *_goodsImg;
    UILabel *_goodsInfo;
}
@end

@implementation WaitSendGoodsInfoCell
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if(self){
        ...
        _goodsImg = [[WXRemotionImgBtn alloc] initWithFrame:CGRectMake(xOffset, (WaitSendGoodsInfoCellHeight-imgHeight)/2, imgWidth, imgHeight)];
