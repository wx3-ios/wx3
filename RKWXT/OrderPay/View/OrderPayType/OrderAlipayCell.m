...
@implementation OrderAlipayCell
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if(self){
        ...
        UIImage *img = [UIImage imageNamed:@"OrderAlipayImg.png"];
        UIImageView *imgView = [[UIImageView alloc] init];
        imgView.frame = CGRectMake(xOffset, (OrderAlipayCellHeight-imgHeight)/2, imgWidth, imgHeight);
