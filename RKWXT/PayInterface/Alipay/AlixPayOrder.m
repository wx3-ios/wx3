...
- (NSString *)description {
	...
	[discription appendFormat:@"&return_url=\"%@\"", self.returnUrl ? self.returnUrl : @"http://yun.67call.com/pay_callback/alipay/php/notify_url.php"];
	[discription appendFormat:@"&it_b_pay=\"%@\"", self.itBPay ? self.itBPay : @"1d"];
	[discription appendFormat:@"&show_url=\"%@\"", self.showUrl ? self.showUrl : @"http://yun.67call.com/pay_callback/alipay/php/notify_url.php"];
