 ...
 */
#ifndef __IT_COMPAT_CC_GCCE_H__
#define __IT_COMPAT_CC_GCCE_H__
...
#define IT_CC_NAME        "gcce"
#define IT_CC_VER_1        __GCCE__
#define IT_CC_VER_2        __GCCE_MINOR__
#define IT_CC_VER_3        __GCCE_PATCHLEVEL__
