...
//@interface T_MenuVC()<UITableViewDataSource,UITableViewDelegate,T_GoodsInfoModelDelegate,deleteStoreGoods,UIAlertViewDelegate,OrderConfirmVCDelegate>{
//    WXUITableView *_tableView;
//    T_Sqlite *_fmdb;
//    T_GoodsInfoModel *_model;
//    NSArray *_oldArr;
//    NSInteger _goodsID;
...
//-(id)init{
//    if(self = [super init]){
//        _model = [[T_GoodsInfoModel alloc] init];
...
//    [self unShowWaitView];
//    [_arr addObject:_model.goodInfoEntity];
...
//            T_GoodInfoEntity *ent = [_arr objectAtIndex:i];
