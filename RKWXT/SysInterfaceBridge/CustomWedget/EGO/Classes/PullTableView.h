...
@optional
//default is YES
- (BOOL)shouldSetHeadRefreshView;
//default is YES
- (BOOL)shouldSetFootRefreshView;
@end


@interface PullTableView : WXUITableView <EGORefreshTableHeaderDelegate, LoadMoreTableFooterDelegate>{
