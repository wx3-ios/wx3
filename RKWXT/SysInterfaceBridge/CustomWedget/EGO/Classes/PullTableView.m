...
- (BOOL)isSetHeadRefreshView{
    BOOL ret = YES;
    if(pullDatasource && [pullDatasource respondsToSelector:@selector(shouldSetHeadRefreshView)]){
        ret = [pullDatasource shouldSetHeadRefreshView];
    }
    return ret;
}
- (BOOL)isSetFootRefreshView{
    BOOL ret = YES;
    if(pullDatasource && [pullDatasource respondsToSelector:@selector(shouldSetFootRefreshView)]){
        ret = [pullDatasource shouldSetFootRefreshView];
    }
    return ret;
}
