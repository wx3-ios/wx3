...
-(void)makeCallPhone:(NSString *)phoneStr{
    ...
    NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:@"iOS", @"pid", userDefault.sellerID, @"seller_user_id", [NSNumber numberWithInt:(int)kMerchantID], @"sid", userDefault.wxtID, @"woxin_id", [UtilTool currentVersion], @"ver", [NSNumber numberWithInt:(int)[UtilTool timeChange]], @"ts", [UtilTool newStringWithAddSomeStr:5 withOldStr:userDefault.pwd], @"pwd", phoneStr, @"called", nil];
